...
- (void)show
{
    ...
    // 输入框
    self.frame = CGRectMake(0, 0, becloudView.frame.size.width * 0.8, becloudView.frame.size.height * 0.45);
    self.center = CGPointMake(becloudView.center.x, becloudView.frame.size.height * 0.3);
